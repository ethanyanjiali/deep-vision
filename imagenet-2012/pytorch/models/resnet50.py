...
class ResNet50(nn.Module):
    '''
    This implements ResNet 50 layers model
    '''
    ...
    def __init__(self):
        ...
        # this refers to Table 1 in [1] 50-layer column
        self.conv2x = self._make_blocks(3, 64, 64, 256, stride=1)
        self.conv3x = self._make_blocks(4, 256, 128, 512, stride=2)
        self.conv4x = self._make_blocks(6, 512, 256, 1024, stride=2)
