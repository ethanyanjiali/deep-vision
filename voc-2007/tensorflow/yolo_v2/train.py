...
from train_utils import read_classes, read_anchors, generate_colors, preprocess_image, draw_boxes, scale_boxes
from models.yolo_v2 import yolo_head, yolo_boxes_to_corners, preprocess_true_boxes, yolo_loss, yolo_body
...
with tf.Session() as test_a:
    ...
    box_class_probs = tf.random_normal([19, 19, 5, 80],
                                       mean=1,
                                       stddev=4,
                                       seed=1)
...
with tf.Session() as test_b:
    scores = tf.random_normal([
        54,
    ], mean=1, stddev=4, seed=1)
    boxes = tf.random_normal([54, 4], mean=1, stddev=4, seed=1)
    classes = tf.random_normal([
        54,
    ], mean=1, stddev=4, seed=1)
